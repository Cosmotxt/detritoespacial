            ...
            <div id='' className="w-[90vw] mx-auto">
                <div id="parte1" className="flex flex-col h-auto pb-[20rem]">
                    <div className="flex flex-wrap lg:absolute">
                        <img src={fotoEnsaio1} alt="" className="w-[300px] pb-7 lg:pb-0 lg:w-[600px] mx-auto lg:mx-0 z-30 lg:mr-5 lg:pt-4" />
                    ...
                    <div className="flex flex-col lg:flex-row items-center lg:mt-20 lg:relative lg:items-start top-[19rem] left-[25rem]">
                        <img src={fotoEnsaio2} alt="" className="w-[400px] pb-7 lg:pb-0 z-20 lg:mr-5 pt-6 scale-x-[-1]" />
